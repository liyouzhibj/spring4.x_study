...
/**
 * @description 用户数据访问
 * @create by lijing on 2017-11-27 14:40
 **/
@Repository
public class UserDao {
    ...
    private final static String GET_USER_BY_USER_NAME_SQL = "SELECT * FROM t_user WHERE user_name =?";
    ...
    public User findUserByUserName(final String userName){
        ...
        jdbcTemplate.query(GET_USER_BY_USER_NAME_SQL, new Object[]{userName},
                //匿名类方式实现的回调函数
